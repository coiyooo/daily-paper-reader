...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-07 21:29:00 UTC<br>状态：成功</p>
</section>
...
<p>今日共读10篇机器人学习论文，精读4篇、速读6篇，聚焦操作技能与智能体训练。最值得关注《SkillMemo》提出的专家引导技能记忆框架（9.0分），以及《Weights or Skills?》对机器人学习技术的系统综述（8.0分）。建议普通读者优先从技能复用与分层策略入手，理解机器人如何从“预测动作”走向“自主写技能”。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="SkillMemo: Expert-guided Skill Memory Framework for Compositional Embodied Manipulation">SkillMemo: Expert-guided Skill Memory Framework for Compositional Embodied Manipulation</span></li><li><span class="dpr-home-dashboard-paper-title" title="Weights or Skills? A Survey of Robot-Learning Techniques: from Action-Predicting Weights to Robots that Write their Own Skills">Weights or Skills? A Survey of Robot-Learning Techniques: from Action-Predicting Weights to Robots that Write their Own Skills</span></li><li><span class="dpr-home-dashboard-paper-title" title="Field Aware Agent Skill Retrieval">Field Aware Agent Skill Retrieval</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="SSC: A Verifiable Structured Representation for Bimanual Manipulation Labelling">SSC: A Verifiable Structured Representation for Bimanual Manipulation Labelling</span></li><li><span class="dpr-home-dashboard-paper-title" title="Beyond Flat Policies: Hierarchical Post-Training for Embodied Agents in Robotic Manipulation">Beyond Flat Policies: Hierarchical Post-Training for Embodied Agents in Robotic Manipulation</span></li><li><span class="dpr-home-dashboard-paper-title" title="RoboReact: Agentic Skill Distillation from Generated Egocentric Videos for Generalizable Whole-Body Manipulation">RoboReact: Agentic Skill Distillation from Generated Egocentric Videos for Generalizable Whole-Body Manipulation</span></li></ul>
  </div>
