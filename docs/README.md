...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-19 21:55:13 UTC<br>状态：成功</p>
</section>
...
<p>今天精选2篇速读论文，聚焦长程机器人操作与技能图谱更新。可关注MaskHarness-WAM的实例化长程操作方案，以及SkillAA用归因引导技能图更新并支持验证回滚。建议普通读者优先扫读这两篇摘要，判断是否与自身机器人学习场景相关。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="MaskHarness-WAM: Instance-Grounded Harnessing for Long-Horizon Robot Manipulation">MaskHarness-WAM: Instance-Grounded Harnessing for Long-Horizon Robot Manipulation</span></li><li><span class="dpr-home-dashboard-paper-title" title="SkillAA: Attribution-Guided Skill-Graph Updating with Targeted Validation and Rollback">SkillAA: Attribution-Guided Skill-Graph Updating with Targeted Validation and Rollback</span></li></ul>
  </div>
